...
final class HomeRepairQuoteLogUITests: XCTestCase {
    ...
    func testAddItemFlow() {
        ...
        let field1 = app.textFields["fieldContractor"]
        XCTAssertTrue(field1.waitForExistence(timeout: 2))
        field1.tap()
        field1.typeText("Test Contractor")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Contractor"].waitForExistence(timeout: 2))
    }
